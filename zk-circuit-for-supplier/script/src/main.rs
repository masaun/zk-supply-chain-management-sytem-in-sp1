...
fn main() {
    ...
    let manufacturing_order: ProductDetail = ProductDetail {
        serial_number: 1,
        upc_or_ean: 1234567891234, // Product Code (1) - UPC or EAN barcode (UPC:12 ~ 13 digits))
        gtin: 123456789123,        // Product Code (2) - GTIN-12 code (12 digits)
    ...
    println!("ProductDetail - serial_number: {}", manufacturing_order.serial_number);
    println!("ProductDetail - upc_or_ean: {}", manufacturing_order.upc_or_ean);
    println!("ProductDetail - gtin: {}", manufacturing_order.gtin);
    println!("ProductDetail - product_description: {}", manufacturing_order.product_description);
    println!("ProductDetail - batch_number: {}", manufacturing_order.batch_number);
    println!("ProductDetail - is_food: {}", manufacturing_order.is_food);
    println!("ProductDetail - expiration_date: {}", manufacturing_order.expiration_date);
    println!("ProductDetail - temperature: {}", manufacturing_order.temperature);
    println!("ProductDetail - location_origin: {}", manufacturing_order.location_origin);
    println!("ProductDetail - location_destination: {}", manufacturing_order.location_destination);
    println!("ProductDetail - order_date: {}", manufacturing_order.order_date);
    println!("ProductDetail - shipping_date: {}", manufacturing_order.shipping_date);
    println!("ProductDetail - supplier_ids: {}", manufacturing_order.supplier_ids);
    println!("ProductDetail - supplier_certificates: {}", manufacturing_order.supplier_certificates);
    println!("ProductDetail - supplier_signatures: {}", manufacturing_order.supplier_signatures);
    println!("ProductDetail - supplier_wallet_addresses: {}", manufacturing_order.supplier_wallet_addresses);
